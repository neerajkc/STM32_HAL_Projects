 ...
 *      Author: neeraj5k
 *
 *  TIM2 can be driven by either LSE or HSI (connect jumper from PA0 to PA8).
 *  However, while LSE is not very accurate, HSI's 4MHz is too fast for IRQ handling.
 *  TIM6 is a basic timer that runs on PA5 (GPIO led).
 */
...
void LSE_Configuration(void)
{
	...
	/* Code below sends LSE output to MCO1 pin(PA8) */
	//HAL_RCC_MCOConfig(RCC_MCO1, RCC_MCO1SOURCE_LSE, RCC_MCODIV_1);

	/* Code below sends HSI output to MCO1 pin(PA8) */
